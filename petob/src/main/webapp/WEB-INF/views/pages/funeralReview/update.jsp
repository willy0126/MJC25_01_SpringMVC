...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <%-- 게시글 수정 --%>
                <form id="updateForm" action="/FuneralReview-posts/${post.id}/update" method="POST" enctype="multipart/form-data">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <c:if test="${not empty post.fileName}">
                                <div class="mb-3">
                                    <div class="mb-2">
                                        <span>현재 파일: <a href="/FuneralReview-posts/${post.id}/download" class="btn btn-outline-primary">${post.originalFileName}</a></span>
                                    </div>
