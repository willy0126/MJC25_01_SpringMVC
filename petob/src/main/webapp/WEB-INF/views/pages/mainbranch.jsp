            ...
            <div class="page-wrapper">
                <main class="main-wrapper">
                    <div class="site-container">
                        <h3 class="page-section-title content-fade-in"><b>본점</b></h3>
                        <div class="row g-2">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4 mt-3 mt-md-0 ps-md-2 content-fade-in delay-2">
                                ...
                                <p class="address-info-line first-address-line d-flex align-items-center">
                                    <span><b>지점 주소:</b>서울특별시 서대문구 가좌로 134</span>
                                    <a href="${pageContext.request.contextPath}/location?branch=main"
                                ...
                                <a href="${pageContext.request.contextPath}/obituary-reservation/form?branch=main" class="btn btn-primary mt-3">본점 예약하기</a>
                            </div>
                        </div>
                    </div>
                </main>
