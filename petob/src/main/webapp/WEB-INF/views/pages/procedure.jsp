          ...
          <div class="d-flex justify-content-between mb-4">
            <c:forEach var="i" begin="1" end="8">
              <div class="text-center flex-fill">
                ...
                <c:choose>
                  <c:when test="${i == 1}"><p class="mb-0">지점 확인</p></c:when>
                  <c:when test="${i == 2}"><p class="mb-0">지점 선택</p></c:when>
                  <c:when test="${i == 3}"><p class="mb-0">날짜 선택</p></c:when>
                  <c:when test="${i == 4}"><p class="mb-0">정보 입력</p></c:when>
                  <c:when test="${i == 5}"><p class="mb-0">예약 신청</p></c:when>
                  <c:when test="${i == 6}"><p class="mb-0">예약 승인</p></c:when>
                  <c:when test="${i == 7}"><p class="mb-0">지점 방문</p></c:when>
                  <c:when test="${i == 8}"><p class="mb-0">장례 진행</p></c:when>
                </c:choose>
              </div>
            </c:forEach>
          </div>
        ...
        <div class="site-container">
          ...
          <ul class="item-list list-unstyled">
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item01.png"
                      alt="화장 서비스 아이콘">
                </div>
            ...
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item02.png"
                      alt="장례 의전 아이콘">
                </div>
            ...
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item03.png"
                      alt="장례 의전2 아이콘">
                </div>
            ...
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item04.png"
                      alt="장례 의전3 아이콘">
                </div>
            ...
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item05.png"
                      alt="장례 의전4 아이콘">
                </div>
            ...
            <li class="item">
              <div class="card">
                <div class="item-icon mb-3">
                  <img src="${pageContext.request.contextPath}/resources/img/service_item06.png"
                      alt="장례 의전5 아이콘">
                </div>
