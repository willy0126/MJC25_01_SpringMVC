<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>서대문점 - Star's Haven, 반려동물 장례식장</title>
            ...
            <div class="page-wrapper">
                <main class="main-wrapper">
                    <div class="site-container">
                        <h3 class="page-section-title content-fade-in"><b>서대문점</b></h3>
                        <div class="row g-2">
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4 mt-3 mt-md-0 ps-md-2 content-fade-in delay-2">
                                <h5>한 순간의 기억으로 영원히 남을 수 있게,<br>여기는 <b>Star's Haven 서대문점</b>입니다.
                                </h5>
                                <p>
                                ...
                                <p class="address-info-line first-address-line d-flex align-items-center">
                                    <span><b>지점 주소:</b>서울특별시 서대문구 경기대로 82</span>
                                    <a href="${pageContext.request.contextPath}/location?branch=seodaemun"
                                        class="btn btn-outline-secondary btn-xs view-map-btn" target="_blank">지도 보기</a>
                                </p>
                                <p class="address-info-line">
                                    <b>지점 번호:</b> 02-xxx-xxxx
                                </p>
                                <p class="address-info-line">
                                    <b>운영 시간:</b> 09:00 ~ 18:00 (토요일, 일요일 휴무)
                                </p>
                                <p class="mt-3">
