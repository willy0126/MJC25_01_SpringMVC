             ...
             <aside class="mypage-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul>
                        ...
                        <li class="nav-item"><a href="<c:url value='/mypage/change-password'/>">비밀번호 변경</a></li>
                        <li class="nav-item active"><a href="<c:url value='/mypage/withdraw'/>">회원 탈퇴</a></li>
                    </ul>
                </nav>
            </aside>
                ...
                <section class="withdrawal-container">
                    ...
                    <form action="<c:url value='/mypage/withdraw'/>" method="post" id="withdrawForm">
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="password" placeholder="계정 비밀번호를 다시 입력해주세요." required>
                            <div class="form-text">회원 탈퇴를 위해 비밀번호를 다시 한번 입력해주세요.</div>
                        </div>
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" value="true" id="confirmWithdrawCheck" name="confirmWithdraw" required>
