                                    ...
                                    <div class="form-container">
                                        <c:choose>
                                            <c:when test="${not empty notice.id}">
                                                <!-- 수정 모드 -->
                                                <form id="noticeForm"
                                                    action="<c:url value='/notice/update/${notice.id}'/>" method="post">
                                            </c:when>
                                            <c:otherwise>
                                                <!-- 작성 모드 -->
                                                <form id="noticeForm" action="<c:url value='/notice/save'/>"
                                                    method="post">
                                            </c:otherwise>
                                        </c:choose>
                                        ...
                                        <c:if test="${not empty notice.id}">
                                            <div class="form-group">
                                                <label>기존 정보</label>
                                                <div
                                                    style="padding: 15px; background: #f8f9fa; border-radius: 8px; border: 1px solid #e9ecef;">
                                                    <c:if test="${notice.createdDate != null}">
                                                        <div style="margin-bottom: 8px;">
                                                            <strong>작성일:</strong>
                                                            ${notice.createdDate.toLocalDate()}
                                                            ${notice.createdDate.toLocalTime()}
                                                        </div>
                                                    </c:if>
                                                    <c:if
                                                        test="${notice.updatedDate != null && !notice.updatedDate.equals(notice.createdDate)}">
                                                        <div style="margin-bottom: 8px;">
                                                            <strong>최종 수정일:</strong>
                                                            ${notice.updatedDate.toLocalDate()}
                                                            ${notice.updatedDate.toLocalTime()}
                                                        </div>
                                                    </c:if>
                                                    <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" class="form-input"
                                                value="${notice.title}" placeholder="공지사항 제목을 입력해주세요" maxlength="200"
                                                required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div
                                                style="padding: 12px 15px; background: #f8f9fa; border-radius: 8px; color: #6c757d;">
