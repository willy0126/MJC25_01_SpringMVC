            ...
            <div class="page-wrapper">
                ...
                <div class="main-wrapper">
                    <div class="container obituary-reservation-container">
                        ...
                        <form id="obituaryReservationForm"
                            action="${pageContext.request.contextPath}/obituary-reservation/create" method="post"
                            autocomplete="off">
                            <div class="form-group">
                                ...
                                <select name="branch" id="branchSelect" class="form-control" required>
                                    ...
                                    <option value="본점" <c:if
                                        test="${selectedBranch == '본점' or selectedBranch == 'main'}">selected</c:if>>본점
                                    </option>
                                    <option value="홍대입구점" <c:if
                                        test="${selectedBranch == '홍대입구점' or selectedBranch == 'hongdae'}">selected
                                        </c:if>>홍대입구점</option>
                                    <option value="서대문점" <c:if
                                        test="${selectedBranch == '서대문점' or selectedBranch == 'seodaemun'}">selected
                                        </c:if>>서대문점</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="petWeight" name="petWeight" class="form-control" step="0.1"
                                    placeholder="예: 5.3" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" id="applicantName" name="applicantName" class="form-control"
                                    value="${loginUserName}" required autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="applicantPhone">신청자 전화번호<span class="required">*</span></label>
                                <input type="tel" id="applicantPhone" name="applicantPhone" class="form-control"
                                    value="${loginUserPhone}" placeholder="예: 01012345678 (- 없이 입력)" required
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="funeralDate">장례 희망 날짜<span class="required">*</span></label>
                                <input type="text" id="funeralDate" name="obDate" class="form-control"
