                    ...
                    <main class="main-wrapper">
                        <div class="reservation-container">
                            ...
                            <c:if test="${empty reservations}">
                                ...
                                <form action="<c:url value='/reservation/check'/>" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="phone" name="phone" required placeholder="01012345678"
                                            pattern="[0-9]{9,11}" title="숫자만 입력해주세요 (9~11자리)" value="${phone}">
                                    </div>
                            ...
                            <c:if test="${not empty reservations}">
                                <div class="reservation-info">
                                    <h3><strong>${phone}</strong> 번호로 등록된 예약 (<strong>${reservations.size()}건</strong>)
                                    </h3>
