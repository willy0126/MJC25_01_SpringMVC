                ...
                <main class="main-wrapper">
                    <div class="site-container">
                        <div class="page-title-section"
                            style="margin-top: 100px; margin-bottom: 75px; text-align: center;">
                            <h1>자주 묻는 질문 (FAQ)</h1>
                        </div>
                        ...
                        <div class="faq-container"> <%-- 전체 FAQ 항목을 감싸는 컨테이너 --%>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-answer">
                                        <p>A. 홈페이지 상단의 '회원가입' 메뉴를 통해 가입하실 수 있습니다. 아이디, 비밀번호, 이름, 전화번호, 이메일 정보를 입력하시면
                                            됩니다.</p>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-answer">
                                        <p>A. 상단 메뉴의 '지점 소개' 버튼을 클릭하여 지점을 선택 후 시간을 정해 예약하실 수 있습니다. 간편 상담 예약으로 유선상 답변도
                                            드리고 있습니다.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-answer">
                                        <p>A. 저희 Star's Haven은 현재 본점, 홍대입구점, 서대문점을 운영하고 있습니다. 각 지점의 상세 위치는 홈페이지 '지점 위치'
                                            메뉴에서
                                            확인하실 수 있습니다.</p>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-answer">
                                        <p>A. 이 사이트는 실제 서비스를 제공하는 것이 아니라, 반려동물 장례 서비스에 대한 이해를 돕기 위한 예시 사이트입니다. 실제 서비스는
                                            제공하지 않으며, 학습 및 연습용으로 제작되었습니다.</p>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="faq-item">
                                    ...
                                    <div class="faq-answer">
                                        <p>A. 저희 사이트 제작은 {박지원, 안병준, 안성준, 최서연} 4명의 팀원으로 구성 및 진행했습니다. 각자의 역할을 맡아 사이트를 개발하고
                                            유지보수하고 있습니다.
                                        </p>
                                    </div>
                                </div>
